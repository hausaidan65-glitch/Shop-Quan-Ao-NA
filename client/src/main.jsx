        ...
        <div className="container footerGrid">
          <div className="footerBrand">
            ...
            <p>
              ...
              sinh viên và dân văn phòng. Giao diện demo phục vụ bài AEO/AIEO.
            </p>
          </div>
    ...
    <>
      ...
      <section id="faq" className="faq container section reveal">
        ...
        <details>
          ...
          <p>
            Website demo mô phỏng chính sách đổi trả 7 ngày. Khi làm dự án thật,
            phần này có thể nối thêm đơn hàng, trạng thái đổi trả và thông báo.
          </p>
        </details>
      </section>
    </>
